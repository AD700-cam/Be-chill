        ...
        >
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center z-10">
                ...
                <div className="flex flex-col gap-6 text-center md:text-left">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start mt-8 sm:mt-4 px-4 sm:px-0">
                        <button
                            onClick={() => document.getElementById('flavors')?.scrollIntoView({ behavior: 'smooth' })}
                            className="bg-brand-pink text-white font-bold text-base sm:text-lg px-6 py-3 sm:px-8 sm:py-4 rounded-full shadow-xl hover:scale-105 transition-transform duration-300 w-full sm:w-auto"
                        >
                            See the Menu
                        </button>
                        <button
                            onClick={() => document.getElementById('location')?.scrollIntoView({ behavior: 'smooth' })}
                            className="bg-white text-brand-pink font-bold text-base sm:text-lg px-6 py-3 sm:px-8 sm:py-4 rounded-full shadow-lg border-2 border-brand-pink hover:bg-brand-pink hover:text-white transition-colors duration-300 w-full sm:w-auto"
                        >
                            Find Us
                        </button>
                    </div>
