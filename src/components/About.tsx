            ...
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
                ...
                <div ref={imageRef} className="flex-1 relative group">
                    ...
                    <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-brand-yellow rounded-full border-4 border-white flex items-center justify-center shadow-xl rotate-12 group-hover:rotate-0 transition-transform duration-500 z-20">
                        <span className="text-brand-brown font-black text-center leading-tight">Est.<br />2024</span>
                    </div>
                </div>

                {/* Content Side */}
                <div ref={contentRef} className="flex-1 text-center md:text-left">
                    <h2 className="text-5xl sm:text-6xl md:text-9xl font-black text-brand-brown font-heading mb-6 sm:mb-8 leading-tight uppercase tracking-tighter">
                    ...
                    <div className="space-y-4 sm:space-y-6 text-base sm:text-xl text-brand-brown/80 font-medium leading-relaxed max-w-lg mx-auto md:mx-0">
                        <p>
                            At <span className="text-brand-pink font-black">Be Chill</span>, we believe that happiness is best served frozen. What started as a small dream to redefine the local ice cream experience has grown into a community of dessert enthusiasts.
                        </p>
                        <p>
