                ...
                <div className="flex flex-col gap-6 text-center md:text-left">
                    ...
                    <div className="flex flex-row gap-3 sm:gap-4 justify-center md:justify-start mt-8 sm:mt-4 px-2 sm:px-0 w-full">
                        <button
                            ...
                            className="bg-brand-pink text-white font-bold text-sm sm:text-lg px-4 py-3 sm:px-8 sm:py-4 rounded-full shadow-brand active:scale-95 hover:scale-105 transition-transform duration-300 flex-1 sm:flex-none"
                        >
                            See Menu
                        </button>
                        <button
                            onClick={() => document.getElementById('location')?.scrollIntoView({ behavior: 'smooth' })}
                            className="bg-white text-brand-pink font-bold text-sm sm:text-lg px-4 py-3 sm:px-8 sm:py-4 rounded-full shadow-brand active:scale-95 border-2 border-brand-pink hover:bg-brand-pink hover:text-white transition-all duration-300 flex-1 sm:flex-none"
                        >
                            Find Us
                        </button>
                    </div>
