        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-16 sm:mb-20">
                    <h2 className="text-[clamp(2.5rem,8vw,5rem)] md:text-[clamp(3.5rem,10vw,8rem)] font-black text-brand-brown font-heading text-glow mb-2 sm:mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                    {flavors.map((flavor, index) => (
                        ...
                        >
                            <div className="absolute top-6 sm:top-8 right-8 sm:right-10 text-6xl sm:text-7xl font-black opacity-5 font-heading text-brand-brown">
                                0{index + 1}
                            </div>
                            ...
                            <div className="relative z-10 flex flex-col flex-grow">
                                <h3 className="text-xl sm:text-2xl font-black font-heading text-brand-brown mb-2">{flavor.name}</h3>
                ...
                <div className="mt-32 text-center border-t-2 border-brand-brown/5 pt-16">
                    <div className="inline-flex flex-col items-center">
                        <p className="text-brand-brown/40 font-black uppercase tracking-[0.3em] text-xs italic mb-4">
