export default function WhatsAppButton() {
    ...
    return (
        <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[100] flex flex-col items-end gap-2">
            {/* Optional subtle ping effect behind the button */}
            <div className="absolute inset-0 -z-10 animate-ping rounded-full bg-[#25D366] opacity-30"></div>

            <a
                href={whatsappUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-3 bg-[#25D366] text-white px-5 py-3 md:px-6 md:py-4 rounded-full shadow-[0_8px_30px_rgba(37,211,102,0.4)] hover:shadow-[0_8px_40px_rgba(37,211,102,0.6)] hover:-translate-y-1 transition-all duration-300 border-2 border-white/20"
