                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8">
                    ...
                    >
                        ...
                        <a
                            ...
                            className="bg-white text-brand-pink font-bold py-4 rounded-full text-center active:scale-95 hover:bg-brand-yellow hover:text-brand-brown transition-all shadow-brand flex justify-center items-center gap-3 text-lg z-10 group/btn focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-pink/50"
                        >
